          ...
          <div className="space-y-6">
              ...
              {discountPercentage > 0 && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-6">
                  <p className="text-green-800 font-semibold">
                    🎉 You save {formatPrice(Number(product.originalPrice) - product.price)} with this offer!
                  </p>
                </div>
              )}
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100 shadow-md">
              <div className="text-center mb-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Interested in this product?</h3>
                <p className="text-gray-600">Contact us for pricing, availability, and custom requirements</p>
              </div>
            ...
            {state.products
              ...
              .map(relatedProduct => (
                ...
                >
                  ...
                  />
                  <div className="p-4">
                    <div className="text-xs text-blue-600 font-medium mb-1">{relatedProduct.brand}</div>
                    <h3 className="font-semibold text-gray-900 mb-2 line-clamp-2 text-sm leading-tight">{relatedProduct.name}</h3>
